...
var repository cards.Repository
...
func TestIntegrationCardRepository(t *testing.T) {
	...
	runner.Run(t, func(t *testing.T) {
		repository = cards.NewRepository(runner.Connection(), cfg)
...
func findByName(t *testing.T) {
	...
	result, err := repository.FindByName(ctx, "ummy Card", common.NewPage(1, 3))
...
func findByNameLastPage(t *testing.T) {
	ctx := context.Background()
	result, err := repository.FindByName(ctx, "Dummy Card", common.NewPage(2, 3))
...
func findByNameDoubleFace(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ctx := context.Background()
			result, err := repository.FindByName(ctx, tc.searchTerm, common.NewPage(1, 10))
...
func findByNameNoImageURL(t *testing.T) {
	ctx := context.Background()
	result, err := repository.FindByName(ctx, "No Image Card", common.NewPage(1, 5))
...
func findByNameAndCollector(t *testing.T) {
	...
	result, err := repository.FindByNameWithAmount(ctx, "ummy Card", c, common.NewPage(1, 3))
...
func findByNameAndCollectorDoubleFace(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			ctx := context.Background()
			c := cards.Collector{ID: "myUser"}
			result, err := repository.FindByNameWithAmount(ctx, tc.searchTerm, c, common.NewPage(1, 10))
...
func findByNameAndCollectorNoImageURL(t *testing.T) {
	ctx := context.Background()
	c := cards.Collector{ID: "myUser"}
	result, err := repository.FindByNameWithAmount(ctx, "No Image Card", c, common.NewPage(1, 10))
